    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorites', models.ManyToManyField(to='store.shoe')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_customer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='accounts.customer')),
                ('order_shoe', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='store.shoe')),
            ],
        ),
        migrations.AddField(
            model_name='customer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_info', models.ManyToManyField(to='accounts.paymentinfo')),
            ],
        ),
        migrations.AddField(
            model_name='customer',
            name='payment_methods',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='accounts.paymentmethods'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping_info', models.ManyToManyField(to='accounts.shippinginfo')),
            ],
        ),
        migrations.AddField(
            model_name='customer',
            name='shipping_methods',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='accounts.shippingmethods'),
        ),
    ]
